...
uint256 hashGenesisBlock("0x4cd5d791b2e9b60c50fea7d2ef47fc167e0c5372b2315b5dcc28ad5a69ce22ad");
...
const string strMessageMagic = "8Coin Signed Message:\n";
...
{
    int64 nSubsidy = 0.000008 * COIN;
    nSubsidy >>= (nHeight / 337000); // 8coin: 370k blocks
    
      if(nHeight < 8){
        nSubsidy = 0.008 * COIN; // 0.8% premine
    }

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 8 * 60; // 8Coin: 8 minutes
static const int64 nTargetSpacing = 88; // 8Coin: 88 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal 8coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "8Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcf4bf72e4a2322d1cfc576838d90e544ca3d968c0781c0c3915cedc99f97ad5e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "8coin is released! Good fortune to all!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390180908; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 113799;

        if (fTestNet)
        {
            block.nTime    = 1390179630;
            block.nNonce   = 445025;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x68fa6c49e584468360c4d2aa2143d211f57e908d9736e9459353149bc84c5a5c"));
